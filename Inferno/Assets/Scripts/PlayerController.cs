...
public class PlayerController : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            player.transform.localPosition += new Vector3(scrollController.rectTransform.localPosition.x * 0.008f * (1 + GameManager.Inst().getSpeedLevel() * 0.125f), 0);
            GameManager.Inst().setDistance(GameManager.Inst().getDistance() + scrollController.rectTransform.localPosition.x * 0.008f * (1 + GameManager.Inst().getSpeedLevel() * 0.125f));
